...
class KSAMPLER(Sampler):
    def __init__(self, model_name, sampler_function, extra_options={}, inpaint_options={}):
...
@torch.no_grad()
def sample_dpm_adaptive(model, x, sigma_min, sigma_max, n, extra_args=None, callback=None, disable=None, order=3, rtol=0.05, atol=0.0078, h_init=0.05, pcoeff=0., icoeff=1., dcoeff=0., accept_safety=0.81, eta=0., s_noise=1., noise_sampler=None, return_info=False):
